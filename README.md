...
# Lab (Extra) | Image Classification using CNN
...
As this lab is time consuming, you are presented with a reference solution. Don't abuse it but consult it to unblock you when and if needed.
